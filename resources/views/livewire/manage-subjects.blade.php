            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-white/90 mt-1">
                        Kelola mata pelajaran untuk setiap kelas di Sekolah Dasar.
                    </p>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-purple-50/80">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-purple-700 uppercase">Nama Mata Pelajaran</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-purple-700 uppercase">Kelas</th>
                            ...
                            <tr class="hover:bg-blue-50/80 transition duration-150">
                                ...
                                <td class="px-6 py-4 text-right text-sm font-medium">
                                    ...
                                    <button
                                        ...
                                        wire:confirm="Yakin ingin menghapus mata pelajaran ini? Semua bab dan soal di dalamnya akan ikut terhapus!"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                    Belum ada data mata pelajaran. Silakan tambah data baru.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        >
            ...
            >
                <h2 class="text-2xl font-bold text-purple-700 mb-4">
                    {{ $subjectId ? 'Edit Mata Pelajaran' : 'Tambah Mata Pelajaran Baru' }}
                </h2>

                <form wire:submit.prevent="save">
                    
                    <!-- DROPDOWN KELAS (GRADE) -->
                    <div class="mb-4">
                        <label for="grade_id" class="block text-sm font-medium text-gray-700 mb-1">
                            Pilih Kelas
                        </label>
                        <select 
                            id="grade_id" 
